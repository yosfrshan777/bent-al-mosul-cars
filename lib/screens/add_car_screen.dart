...
class _AddCarScreenState extends State<AddCarScreen> {
  ...
  Future<void> submit() async {
    ...
    try { final result=await widget.api.createCar(brand:brand!,model:model!,year:year!,price:p,city:city!,fuel:fuel,transmission:transmission,description:description.text.trim(),plan:plan,images:images,phone:phone.text.trim(),bodyType:bodyType); if(!mounted)return; _msg('تم إرسال السيارة للمراجعة بنجاح'); Navigator.pop(context,result); }
