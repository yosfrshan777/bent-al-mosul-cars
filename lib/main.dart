      ...
      body: Stack(fit: StackFit.expand, children: [
        ...
        Center(child: AnimatedBuilder(animation: _animation, builder: (_, __) {
          ...
          return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Transform.scale(scale: .88 + (v.clamp(0.0, 1.0) * .12), child: ShaderMask(shaderCallback: (bounds) => const LinearGradient(colors: [kPink, Colors.white, kBlue]).createShader(bounds), child: const Text('ZYOCAR', style: TextStyle(color: Colors.white, fontSize: 42, fontWeight: FontWeight.w900, letterSpacing: 5)))),
...
class _MainShellState extends State<MainShell> {
  ...
  void _openShowrooms() => Navigator.push(context, MaterialPageRoute(builder: (_) => ShowroomsScreen(api: widget.api)));
  void _openParts() => Navigator.push(context, MaterialPageRoute(builder: (_) => PartsScreen(api: widget.api)));

  @override
  Widget build(BuildContext context) {
    final pages = <Widget>[
      HomeScreen(api: widget.api, onOpenCars: () => setState(() => _index = 1), onAddCar: _addCar, onOpenShowrooms: _openShowrooms, onOpenParts: _openParts),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        backgroundColor: const Color(0xFF0D1018), indicatorColor: const Color(0xFF3A1630), height: 78,
        destinations: const [
