...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 1800), () {
      if (!mounted) return;
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => AuthGate(api: widget.api)));
    });
  }
          ...
          child: FadeTransition(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 22),
                Text('بيع وشراء السيارات في العراق', style: TextStyle(color: Colors.white70, fontSize: 13)),
                SizedBox(height: 8),
...
class _MainShellState extends State<MainShell> {
  ...
  Widget build(BuildContext context) {
    final pages = <Widget>[
      ZyoCarHomeScreen(api: widget.api, onOpenCars: () => setState(() => index = 1), onOpenShowrooms: showrooms, onAddCar: addCar),
